...
export const SAMPLE_GITHUB_REPOS: GitHubRepoOption[] = [
  { full_name: "Ananyamadhu08/command-center", description: "" },
  { full_name: "Ananyamadhu08/mcp-issue-tracker", description: "An example app for the Complete Intro to MCP, as taught by Brian Holt for Frontend Masters" },
  { full_name: "Ananyamadhu08/word-trail", description: "" },
  { full_name: "Ananyamadhu08/Auto_job_applier_linkedIn", description: "Auto job applier" },
  { full_name: "Ananyamadhu08/dot-distortion-shader", description: "Reverse-engineered Aceternity UI Dot Distortion Shader — Canvas 2D + WebGL implementations" },
  { full_name: "Ananyamadhu08/greyamp-website-redesign", description: "" },
  { full_name: "Ananyamadhu08/expense-tracker", description: "" },
  { full_name: "Ananyamadhu08/content-workflow-app", description: "" },
  { full_name: "Ananyamadhu08/my-mcp-app", description: "" },
  { full_name: "Ananyamadhu08/task-app", description: "" },
  { full_name: "Ananyamadhu08/sql-apps", description: "Apps for the Complete Intro to SQL" },
  { full_name: "Ananyamadhu08/pixel-lab", description: "" },
  { full_name: "Ananyamadhu08/api-design-node-v5", description: "" },
  { full_name: "Ananyamadhu08/portfolio-website", description: "" },
  { full_name: "Ananyamadhu08/dsa-concept-revision-tuf", description: "" },
  { full_name: "Ananyamadhu08/javascript-questions-learners-bucket", description: "" },
  { full_name: "Ananyamadhu08/dsa-problem-solving", description: "" },
  { full_name: "Ananyamadhu08/greyamp", description: "" },
  { full_name: "Ananyamadhu08/byte-humor", description: "" },
  { full_name: "Ananyamadhu08/ai-landing-page", description: "" },
  { full_name: "Ananyamadhu08/machine-coding-avatar-picker", description: "" },
  { full_name: "Ananyamadhu08/machine-coding-multi-select-search", description: "" },
  { full_name: "Ananyamadhu08/machine-coding-password-generator", description: "" },
  { full_name: "Ananyamadhu08/machine-coding-color-memory-game", description: "" },
  { full_name: "Ananyamadhu08/machine-coding-bar-chart", description: "" },
  { full_name: "Ananyamadhu08/machine-coding-animated-circles-game", description: "" },
  { full_name: "Ananyamadhu08/machine-coding-nested-comments", description: "" },
  { full_name: "Ananyamadhu08/machine-coding-grid-lights", description: "" },
  { full_name: "Ananyamadhu08/machine-coding-tic-tac-toe", description: "" },
  { full_name: "Ananyamadhu08/machine-coding-selectable-grid", description: "" },
  { full_name: "Ananyamadhu08/machine-coding-stepper-component", description: "" },
  { full_name: "Ananyamadhu08/machine-coding-otp-login", description: "" },
  { full_name: "Ananyamadhu08/machine-coding-progress-bar", description: "" },
  { full_name: "Ananyamadhu08/machine-coding-drag-and-drop-notes", description: "" },
  { full_name: "Ananyamadhu08/machine-coding-toast-component", description: "" },
  { full_name: "Ananyamadhu08/machine-coding-emi-calculator", description: "" },
  { full_name: "Ananyamadhu08/machine-coding-pagination", description: "" },
  { full_name: "Ananyamadhu08/machine-coding-file-explorer", description: "" },
  { full_name: "Ananyamadhu08/cuboid-map-client", description: "" },
  { full_name: "Ananyamadhu08/cuboid-map-server", description: "" },
  { full_name: "Ananyamadhu08/movie-watchlist-assignment", description: "" },
  { full_name: "Ananyamadhu08/nextjs-13-introduction", description: "" },
  { full_name: "Ananyamadhu08/machine-coding-countdown-timer", description: "" },
  { full_name: "Ananyamadhu08/machine-coding-employee-database-management", description: "" },
  { full_name: "Ananyamadhu08/user-form-app", description: "" },
  { full_name: "Ananyamadhu08/todo-list-app-redux", description: "" },
  { full_name: "Ananyamadhu08/redux-counter", description: "" },
  { full_name: "Ananyamadhu08/todo-list-app", description: "" },
  { full_name: "Ananyamadhu08/budget-planner-react", description: "" },
  { full_name: "Ananyamadhu08/js-exercise-questions", description: "JavaScript exercise questions for practice " },
  { full_name: "Ananyamadhu08/crud-app-express", description: "A simple CRUD app using express" },
  { full_name: "Ananyamadhu08/leetcode", description: "" },
  { full_name: "Ananyamadhu08/image-background-remover", description: "" },
  { full_name: "Ananyamadhu08/product-photoshoot", description: "" },
  { full_name: "Ananyamadhu08/image-editor-assignment", description: "" },
  { full_name: "Ananyamadhu08/stay-inn", description: "An app for booking short and long-term homestays and experiences." },
  { full_name: "Ananyamadhu08/nexus", description: "A digital collaboration platform" },
  { full_name: "Ananyamadhu08/ratham-backend-assignment", description: "" },
  { full_name: "Ananyamadhu08/go-api-assignment", description: "basic hello world api using go" },
  { full_name: "Ananyamadhu08/student-enrollment-app", description: "An app for student enrollment" },
  { full_name: "Ananyamadhu08/listed-dashboard", description: "A React Dashboard" },
  { full_name: "Ananyamadhu08/listed-backend", description: "" },
  { full_name: "Ananyamadhu08/my-notion-portfolio", description: "" },
  { full_name: "Ananyamadhu08/dashify", description: "An admin dashboard" },
  { full_name: "Ananyamadhu08/metamask-extension", description: ":globe_with_meridians: :electric_plug: The MetaMask browser extension enables browsing Ethereum blockchain enabled websites" },
  { full_name: "Ananyamadhu08/tribeNet", description: "a social media application" },
  { full_name: "Ananyamadhu08/old-portfolio-website-2023", description: "" },
  { full_name: "Ananyamadhu08/wordle-clone", description: "a worldle game" },
  { full_name: "Ananyamadhu08/moonshot-mail", description: "" },
  { full_name: "Ananyamadhu08/wave", description: "a social media application" },
  { full_name: "Ananyamadhu08/Typewriter-backend", description: "" },
  { full_name: "Ananyamadhu08/Meraki-ecom", description: "An ecommerce app" },
  { full_name: "Ananyamadhu08/Typewriter", description: "" },
  { full_name: "Ananyamadhu08/ghost-UI", description: "A component library " },
  { full_name: "Ananyamadhu08/fusion", description: "A component library." },
  { full_name: "Ananyamadhu08/fusion-tv", description: "a video library app" },
  { full_name: "Ananyamadhu08/CAMPfire", description: "A smart pomodoro" },
  { full_name: "Ananyamadhu08/sandpack", description: "A component toolkit for creating live-running code editing experiences, using the power of CodeSandbox." },
  { full_name: "Ananyamadhu08/Rhythm", description: "A music app" },
  { full_name: "Ananyamadhu08/groovy", description: "An opensource music platform built with NextJS/ReactJS and Shazam API" },
  { full_name: "Ananyamadhu08/cauldron", description: "" },
  { full_name: "Ananyamadhu08/NoteStack", description: "A notes app" },
  { full_name: "Ananyamadhu08/itsy-e-commerce", description: "" },
  { full_name: "Ananyamadhu08/webpack-5", description: "webpack for neogcamp" },
  { full_name: "Ananyamadhu08/neoG-questions", description: "" },
  { full_name: "Ananyamadhu08/quiz-mania", description: "A quiz app." },
  { full_name: "Ananyamadhu08/fusion-ecom-screens", description: "Screens for an e-commerce application" },
  { full_name: "Ananyamadhu08/palasio-quiz", description: "" },
  { full_name: "Ananyamadhu08/old-portfolio-website-2022", description: "A simple portfolio website" },
  { full_name: "Ananyamadhu08/practice", description: "" },
  { full_name: "Ananyamadhu08/adopt-me", description: "An adoption app made using react" },
  { full_name: "Ananyamadhu08/banana-speak", description: "" },
  { full_name: "Ananyamadhu08/yoda-speak", description: "an app for yoda lovers " },
  { full_name: "Ananyamadhu08/cash-register", description: "A cash register app" },
  { full_name: "Ananyamadhu08/palindrome-birthday", description: "" },
  { full_name: "Ananyamadhu08/stock-profit-loss-calculator", description: "A stock app to calculate profit and loss" },
  { full_name: "Ananyamadhu08/fun-with-triangles", description: "an app to learn about triangles" },
  { full_name: "Ananyamadhu08/is-your-birthday-lucky", description: "" },
  { full_name: "Ananyamadhu08/Memories", description: "A simple social media app" },
  { full_name: "Ananyamadhu08/tic-tac-toe", description: "A tic tac toe game made using HTML, CSS and JavaScript" },
]
