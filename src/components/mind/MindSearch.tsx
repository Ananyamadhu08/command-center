        ...
        {showDropdown && (
          <motion.div
            ...
            className={cn(
              ...
              "rounded-2xl border border-white/[0.1] bg-space-800/95 backdrop-blur-2xl",
              "shadow-[0_20px_60px_rgba(0,0,0,0.5),0_0_30px_rgba(139,92,246,0.06),inset_0_1px_0_rgba(255,255,255,0.06)]",
              "p-2 max-h-[60vh] overflow-y-auto",
            )}
          >
            {searching && results.length === 0 && (
              <div className="py-8 text-center">
                <Loader2 size={20} className="text-cosmic-light/40 animate-spin mx-auto mb-2" />
                <p className="text-xs text-white/25">Searching your mind...</p>
              </div>
            )}
            ...
            {hasResults && (
              <div className="space-y-0.5">
                <p className="text-[10px] text-white/25 font-mono px-3 py-1.5 tracking-wider uppercase">
                  ...
                  return (
                    <button
                      ...
                      className={cn(
                        ...
                        "hover:bg-white/[0.05] hover:shadow-[inset_0_1px_0_rgba(255,255,255,0.04)]",
                      )}
                    >
